                             ...
                             <div class="row">
                                 <div class="col-4 animate__animated animate__backInLeft">
                                     <img class="img-fluid rounded-circle p-3 mb-3"
                                         src="./images/usher_pic1.jpg" alt="my pic">
                                   <div class="mb-0 d-flex flex-column justify-content-center">
                                     <p class="lead text-center"> My Professional Links :</p>
                                     <div class="liens animate__animated animate__rubberBand animate__delay-4s
                                      text-center">
                                         <a href="https://github.com/Kadev0502" class="liens "
                                            target="_blank">
                                             <i
                                         ...
                                         <a href="https://www.linkedin.com/in/usher-kadio-4ba2a019b/"
                                            class="liens" target="_blank">
                                             <i
                                                 class="fa fa-linkedin d-inline fa-lg mr-3 text-primary"></i>
                                         </a>
