                ...
                <div class="col-12">
                    <div class="tab-content my-2" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="profile" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-4 animate__animated animate__backInLeft">
                                    <img class="img-fluid rounded-circle p-3"
                                        src="./images/profil-pic_2.jpg" alt="my pic">
                                </div>
                                <div class="col-8 text-left animate__animated animate__backInRight animate__delay-2s">
                                    ...
                                    <p>
                                        Depuis que j’ai été retenu et malgré les conditions particulières dans lesquelles nous avons commencé cette formation (merci COVID-19 !!!) ,chaque jour en formation me conforte dans mon choix et je prend un réel plaisir à acquérir apprendre ce métier .
                                        <br><br>
                                 ...
                                 <br>
                                 <p>A part coder ,je suis un passionné de Football que je pratique beaucoup (bon la on va dire que non ...merci encore mister COVID-19?</p>
